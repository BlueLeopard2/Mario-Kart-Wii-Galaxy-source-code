...
static void CannonExitSpeed() {
    const float ratio = (System::sInstance->IsContext(PULSAR_200) || MKWG::System::Is400cc() || MKWG::System::Is99999cc()) ? cannonExit : 1.0f;
...
void EnableBrakeDrifting(Input::ControllerHolder& controllerHolder) {
    if(System::sInstance->IsContext(PULSAR_200) || MKWG::System::Is400cc() || MKWG::System::Is99999cc()) {
