...
enum Context {
    ...
    PULSAR_CHARRESTRICTMALE,
    PULSAR_CHARRESTRICTFEMALE,
    PULSAR_NOINVISWALLS, 
    PULSAR_VEHICLEMODEREGULAR,
    PULSAR_VEHICLEMODEALLINSIDE,
    PULSAR_VEHICLEMODEBIKEINSIDE,
    PULSAR_VEHICLEMODEALLOUTSIDE,
    PULSAR_VEHICLEMODERIIBALANCED,
    PULSAR_VEHICLEMODEGIMMICK,
    PULSAR_ITEMMODEREGULAR,
    PULSAR_ITEMMODEMUSHROOM,
    PULSAR_ITEMMODEBLASTBLITZ,
