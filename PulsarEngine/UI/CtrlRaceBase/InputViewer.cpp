...
u32 CtrlRaceInputViewer::Count() {
    if(static_cast<Pulsar::MKWGSettingInputDisplay>(Pulsar::Settings::Mgr::Get().GetUserSettingValue(static_cast<Pulsar::Settings::UserType>(Pulsar::Settings::SETTINGSTYPE_MKWG3), Pulsar::SETTINGS_INPUT_VIEWER)) == Pulsar::MKWGSETTING_INPUTDISPLAY_ENABLED) {
