...
enum bikeDriftEffects { //_L and _R aren't part of the actual emitter name
    rk_driftSmoke = 0,
    rk_driftSpark1LB_Spark00 = 1,
    rk_driftSpark1LB_Spark01 = 2,
    rk_driftSpark1RB_Spark00 = 3,
    rk_driftSpark1RB_Spark01 = 4,
    rk_driftSpark1CB_Spark00 = 5,
    rk_driftSpark1CB_Spark01 = 6,
    rk_driftSpark1LB1T_Chip00 = 7,
    rk_driftSpark1LB1T_Spark00 = 8,
    rk_driftSpark1LB1T_Spark01 = 9,
    rk_driftSpark1RB1T_Chip00 = 10,
    rk_driftSpark1RB1T_Spark00 = 11,
    rk_driftSpark1RB1T_Spark01 = 12,
    rk_driftSpark1CB1T_Chip00 = 13,
    rk_driftSpark1CB1T_Spark00 = 14,
    rk_driftSpark1CB1T_Spark01 = 15,
    rk_driftSpark1LB_Chip00 = 16,
    rk_driftSpark1RB_Chip00 = 17,
    rk_hangOnL = 18,
    rk_hangOnR = 19,
    rk_hangOnLTail = 20,
    rk_hangOnRTail = 21,
    ...
    rk_start2 = 24,
    rk_brakeSmk = 25,
    rk_driftEffect_27 = 26,
    rk_driftEffect_28 = 27
};
